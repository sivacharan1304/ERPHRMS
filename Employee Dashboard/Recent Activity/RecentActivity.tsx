					...
					<div className='row'>
						<div className='card rounded'>
							<div className='card-header border-0 mb-5 ms-5 mt-5 me-5'>
								<h3 className='card-title text-gray-800 fw-bold'>Recent Activity</h3>
							...
							<div className='card-body'>
								{/* <div className='flex-grow-1 me-5 ms-5 mb-5'>
									<a className='fw-bold text-gray-800 text-hover-primary fs-6'></a>
									<span className='text-muted fw-semibold d-block'>22 hrs ago</span>
								</div> */}
								{data.map((rowData: any, index: any) => (
									<div className='flex-grow-1 me-5 ms-5 mb-5' key={rowData.id}>
										<a
								...
								<div className='d-flex justify-content-end mb-5 mt-7 me-5'>
									<a className='btn btn-sm btn-light-primary '>View All</a>
								</div>
							</div>
						</div>
					</div>
