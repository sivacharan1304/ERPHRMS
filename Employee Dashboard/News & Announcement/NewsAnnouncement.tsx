...
function NewsAnnouncement({className}: Props) {
	const [data, setData] = useState([])
	const Empcode = SessionManager.getEmpID()

	const filllist = () => {
		get('DashBoard/GetEmployeeByEmployeeCode?empCode=3').then((result) => {
			var i = 1
			let data1: any = []
					...
					<div className='row'>
						<div className='card rounded '>
							<div className='card-header border-0 mb-5 ms-5 mt-5 me-5'>
								<h3 className='card-title text-gray-800 fw-bold'>News & Announcements</h3>
